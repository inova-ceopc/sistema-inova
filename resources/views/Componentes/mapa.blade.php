...
<div class="box box-info ">
    ...
    <h3 class="box-title">@yield('tituloBoxMapa')</h3>
        <h5 class="text-left">@yield('subtituloBoxMapa')</h5>
        ...
        <div class="box-body">
        <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="400px" height="420px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
            <g>
            <a id="tocantins" data-toggle="tooltip" xlink:href="#tocantins">
