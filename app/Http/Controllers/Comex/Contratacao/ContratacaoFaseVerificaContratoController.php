...
class ContratacaoFaseVerificaContratoController extends Controller
{
    ...
    //     $demandaContratacao = ContratacaoDemanda::with(['EsteiraContratacaoUpload', 'EsteiraContratacaoUpload.EsteiraDadosContrato'])->whereIn('statusAtual', ['CONTRATO PENDENTE'])->get();
    ...
    //         $contadorDemandasPendentes = ContratacaoFaseVerificaContratoController::arquivaDemanda((array) $verificaContratoAssinado[0]->EsteiraContratacaoUploadConsulta->idDemanda);
